...
public class HeadProjectile : Projectile
{
    ...
    public void ConfigMovement(Vector3 pos, Vector3 target, Transform back, Action callback)
    {
        m_callback = callback;
    ...
    private void Update()
    {
        ...
        if (Vector2.Distance(m_backTransform.position, transform.position) < 0.2f) Destroy();
    }
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        {
            enemy.TakeDamage(m_data.Damage, 322);
        }
